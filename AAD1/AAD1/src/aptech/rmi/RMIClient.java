...
public class RMIClient extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(txtCM)
                        .addComponent(txtIN, javax.swing.GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE)))
    ...
    private void btnConvertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConvertActionPerformed
        try {
            String rmi_URL = "rmi://localhost:9999/Converter";
            Object obj = Naming.lookup(rmi_URL);
            if (obj instanceof ConverterRemote) {
                double cm = Double.parseDouble(txtCM.getText());
                ConverterRemote ri = (ConverterRemote) Naming.lookup(rmi_URL);
                double in = ri.convert(cm);
                txtIN.setText(Double.toString(in));
            }
